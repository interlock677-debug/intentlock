...
- [Developer Examples](developer/EXAMPLES.md) — multi-agent, LangChain, HITL, Docker, K8s
...
- [Target Market](business/TARGET_MARKET.md) — buyer personas, use cases, market trends
- [Pitch Deck](business/IntentLock_v4.0_Pitch_Deck.pptx) — investor / sales presentation

## Commercial

- [Launch Announcement](commercial/LAUNCH_ANNOUNCEMENT.md) — press release and launch messaging
- [Competitive Comparison](commercial/COMPETITIVE_COMPARISON.md) — IntentLock vs. custom middleware, framework guardrails, and API security gateways
- [Enterprise Deployment Guide](commercial/ENTERPRISE_DEPLOYMENT.md) — multi-tenant, multi-region, air-gapped, K8s, DR, compliance
